...
> 🎯 **DA CADEIRA DO CTO**
> Em qualquer sistema de IA que toca decisão sobre pessoas, o controle que exigiria antes de ir a produção é o adversarial set com currículos pareados — obrigatório, com threshold de bloqueio definido antes de ver os resultados. Sem ele, não existe piloto: existe exposição a passivo jurídico não medido. A rubrica que parece neutra quase sempre carrega o viés de quem a escreveu. O adversarial é o único instrumento que torna esse viés visível antes de escalar.
...
Essa última proteção é deliberada. Um aluno que delegou o projeto para a IA sem internalizar o método não passa na defesa oral — porque a banca pergunta sobre a decisão, não sobre o output. A rubrica premia decisão informada, não apresentação polida.
...
O problema não era tecnológico. Era de arquitetura de conhecimento.

### Tese — knowledge cell por cliente

A Atlas estruturou uma "knowledge cell" por cliente ativo usando Claude Projects como contêiner de contexto e Claude Skills como codificação do método de entrega. A lógica é direta: um Project por cliente ativo concentra o histórico, os materiais aprovados, as preferências de formato e o contexto do engajamento. Cinco Skills proprietárias codificam o padrão de output da Atlas — o estilo editorial, a estrutura canônica, o nível de detalhe esperado por tipo de entregável.
...
O critério transferível: **em consultoria, o risco de IA não é que o modelo produza output de baixa qualidade — é que produza output de aparência impecável com dado incorreto**. Golden set com faithfulness numérico é o controle que fecha essa lacuna. Sem ele, a melhoria de produtividade existe, mas o risco de incidente de qualidade também.
...
**Quarto: construiu mecanismo de detecção de degradação.** Adversarial mensal em RH. Defesa oral em educação. Golden set com threshold de bloqueio em consultoria. Os três reconhecem que o risco não é na implantação — é na degradação silenciosa após a implantação.
